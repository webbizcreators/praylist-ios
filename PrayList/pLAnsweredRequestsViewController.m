//
//  pLAnsweredRequestsViewController.m
//  PrayList
//
...
#import "pLAnsweredRequestsViewController.h"
...
@interface pLAnsweredRequestsViewController ()

@end

@implementation pLAnsweredRequestsViewController
...
-(void)loadDatawithIndicator:(BOOL)withindicator{
    ...
    NSString *objectpath = @"lists/myprayerlist/answered/";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.row==0){
        ...
        UITableViewCell *cell = (UITableViewCell *)[tableView dequeueReusableCellWithIdentifier: @"answerfeedheadercell"];
        
        if (cell == nil)
        {
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"pLAnswerFeedHeaderCellView" owner:self options:nil];
    ...
    pLPrayerListItemCell *cell = (pLPrayerListItemCell *)[tableView dequeueReusableCellWithIdentifier: CustomCellIdentifier];
...
-(void)deleterequestfromsender:(id)sender{
    ...
    pLPrayerRequestListItem *pr = [prayerrequests2 objectAtIndex:indexPath.row];
    ...
    [[RKObjectManager sharedManager] deleteObject:pr path: nil parameters: nil success:^( RKObjectRequestOperation *operation , RKMappingResult *mappingResult){
        ...
        if(mappingResult.array.count>0){
            ...
            [prayerrequests2 removeObjectAtIndex:indexPath.row];
